/*
    Simple example, first try to have working code. 
...
float txValue = 0;
const int readPin = 33; // Use GPIO number. See ESP32 board pinouts
...
//    pCharacteristic->setValue(&txValue, 1); // To send the integer value
      ...
      //pCharacteristic->setValue("connected"); // Sending a test message
